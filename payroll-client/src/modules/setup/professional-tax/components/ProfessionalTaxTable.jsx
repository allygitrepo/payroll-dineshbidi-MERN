            ...
            <div key={item.id} className={styles.mobileCard} onClick={() => onEdit ? onEdit(item) : null}>
              ...
              <div className={styles.mobileCardBody}>
                <div className={styles.mobileCardRow}>
                  <span className={styles.mobileCardLabel}>From:</span>
                  <span className={styles.mobileCardValue}>{item.from}</span>
                </div>
                <div className={styles.mobileCardRow}>
                  <span className={styles.mobileCardLabel}>To:</span>
                  <span className={styles.mobileCardValue}>{item.to}</span>
                </div>
                <div className={styles.mobileCardRow}>
                  <span className={styles.mobileCardLabel}>Tax Rate:</span>
                  <span className={styles.mobileCardValue}>{item.taxRate}</span>
                </div>
              </div>
              {(onEdit || onDelete) && (
