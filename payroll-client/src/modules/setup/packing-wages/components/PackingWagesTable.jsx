...
const PackingWagesTable = ({ data, searchTerm, onSearchChange, onEdit, onDelete }) => {
        ...
        <table className={styles.table}>
          ...
          <tbody>
            {paginatedData.length === 0 ? (
              <tr>
                <td colSpan={(onEdit || onDelete) ? 9 : 8} style={{ textAlign: 'center', padding: '30px', color: 'var(--text-muted)' }}>
...
export default PackingWagesTable;
